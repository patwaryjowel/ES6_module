...
function pluginsRelatedCssRoot(done) {
    gulp.src(src.pluginsCssRelFolderRoot)
...
gulp.task('allTask', gulp.series(fonts, html, vendorCss, pluginsCss, pluginsRelatedCssRoot, styleCss, scss, vendorJs, pluginsJs, pluginsRelatedJs, pluginsRelatedJsRoot, mainJs, imageOptimize));
...
function watchFiles() {
    ...
    gulp.watch(src.pluginsCssRelFolderRoot, gulp.series(pluginsRelatedCssRoot, reload));
